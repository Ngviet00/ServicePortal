...
namespace ServicePortals.Application.Services.MemoNotification
{
    public class MemoNotificationService : IMemoNotificationService
    {
        ...
        //{
        //    int? chucDanhId = request.ChucDanhId;
        ...
        //        nextPositionId = approvalFlow?.ToPositionId;
        ...
        //        var approvalFlow = await _context.ApprovalFlows.FirstOrDefaultAsync(e => e.RequestTypeId == requestTypeId && e.FromPositionId == positionId);

        //        if (approvalFlow != null)
        //        {
        //            statusApplicationForm = (int)StatusApplicationFormEnum.FINAL_APPROVAL;
        //            nextPositionId = approvalFlow?.ToPositionId ?? positionId;
        //        }
        //        else
        //        {
        ...
        //            {
        //                nextPositionId = workFlowStepOfStaff?.ToSpecificOrgUnitId;
