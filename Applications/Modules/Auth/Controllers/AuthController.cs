...
using LoginRequestDto = ServicePortal.Applications.Modules.Auth.DTO.Requests.LoginRequestDto;
...
namespace ServicePortal.Applications.Modules.Auth.Controllers
{
